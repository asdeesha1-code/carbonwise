...
const styles = StyleSheet.create({
  ...
  menuCard: { backgroundColor: C.surface, borderRadius: 18, padding: 15, borderWidth: 1, borderColor: C.border, flexDirection: "row", alignItems: "center", gap: 12 }, menuIcon: { width: 38, height: 38, borderRadius: 19, backgroundColor: C.cream, alignItems: "center", justifyContent: "center" }, menuIconText: { color: C.coral, fontSize: 20, fontWeight: "800" }, menuBody: { flex: 1 }, menuTitle: { color: C.ink, fontSize: 14, fontWeight: "800" }, menuCopy: { color: C.muted, fontSize: 11, lineHeight: 16, marginTop: 3 }, chevron: { color: C.coral, fontSize: 24 }, receipt: { backgroundColor: C.ink, borderRadius: 18, padding: 18 }, receiptBrand: { color: C.mint, fontSize: 10, letterSpacing: 1.5, fontWeight: "800", marginBottom: 18 }, receiptLine: { color: "#AAB7B0", fontSize: 10, letterSpacing: 1, fontWeight: "800" }, receiptMetric: { color: "#FFF", fontSize: 30, fontWeight: "800", marginTop: 7, marginBottom: 20 }, dashes: { borderTopWidth: 1, borderTopColor: "#3D4B45", paddingTop: 10, marginTop: 10, flexDirection: "row", justifyContent: "space-between" }, receiptValue: { color: "#FFF", fontSize: 12, fontWeight: "800" }, receiptNote: { color: "#C5D3CB", fontSize: 12, lineHeight: 17, marginTop: 20 }, card: { backgroundColor: C.surface, borderRadius: 20, padding: 17, borderWidth: 1, borderColor: C.border }, cardTitle: { color: C.ink, fontSize: 16, fontWeight: "800" }, cardCopy: { color: C.muted, fontSize: 12, lineHeight: 18, marginTop: 7 }, demoButton: { alignSelf: "flex-start", backgroundColor: C.cream, borderRadius: 14, paddingHorizontal: 13, paddingVertical: 10, marginTop: 13 }, demoText: { color: C.coral, fontSize: 12, fontWeight: "800" }, methodRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 13 }, methodDot: { width: 9, height: 9, borderRadius: 5 }, methodText: { color: C.ink, fontSize: 12 }, footer: { color: C.muted, textAlign: "center", fontSize: 11, marginTop: 5 }
});
